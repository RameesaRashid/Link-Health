...
export const createDoctorProfile = async (req: DoctorProfileRequest, res: Response): Promise<Response> => {
    try {
...
export const generateAvailableSlots = async (req: GenerateSlotsRequest, res: Response): Promise<Response> => {
    try {
        const userId = req.user?.userId;
